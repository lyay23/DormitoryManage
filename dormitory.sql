...
CREATE TABLE `admin`  (
  ...
  `gender` enum('男','女') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '男' COMMENT '性别1男2女',
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('admin', '123456', '大强', '男', 18, '14785412478', NULL, 'c4063718784b4e259a61c3e56f2ba01d.png');
INSERT INTO `admin` VALUES ('Atest', '123456', '测试管理员', '男', 22, '14785412478', NULL, NULL);
INSERT INTO `admin` VALUES ('lisi', '123456', NULL, '男', 0, NULL, NULL, NULL);
INSERT INTO `admin` VALUES ('zhangsan', '123456', '张三', '男', 20, '15678769876', NULL, NULL);
...
-- ----------------------------
INSERT INTO `dorm_room` VALUES (1101, 1, 1, 4, 3, 'stu22', 'stu100', NULL, 'stu4');
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES (1, '大风提醒', '<p>近期天气变化不定，根据武汉市天气预警近期会有大风天气，请各位同学注意</p>', '张三', '2025-05-16 21:28:36');
INSERT INTO `notice` VALUES (2, '关于宿舍卫生的新规定', '<p>学生公寓是学生们主要的生活区域，兼具休息、学习、交际等多种功能，是培养、提升学生全面素质不可或缺的重要阵地。为了培养学生良好的行为素养和生活习惯，请各位同学注意素质宿舍卫生谨防疾病</p>', '张三', '2025-05-16 21:28:51');
...
-- Records of repair
-- ----------------------------
INSERT INTO `repair` VALUES (-12455934, '张三', 1, 1101, '阳台漏水', '阳台使用时会漏水请来修理', '未完成', '2023-10-14 20:37:35', NULL);
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('Stest', '123456', 22, '欢欢', '男', '13233332222', NULL, NULL);
INSERT INTO `student` VALUES ('stu1', '123456', 18, '张三', '男', '15833332222', '123@qq.com', 'fc5a1fb5e81144c9b122d69c920a0cd7.jpg');
INSERT INTO `student` VALUES ('stu10', '123456', 19, '马克', '女', '15833333333', NULL, NULL);
INSERT INTO `student` VALUES ('stu100', '123456', 22, '雪雪', '男', '17898786787', '123@qq.com', '846787dec80848d3b886723fa23b8f36.PNG');
...
INSERT INTO `student` VALUES ('stu18', '123456', 19, '茵茵', '女', '14785635874', 'akk@akkmail.com', NULL);
INSERT INTO `student` VALUES ('stu19', '123456', 19, '语语', '男', '15889658475', NULL, NULL);
...
INSERT INTO `student` VALUES ('stu9', '123456', 20, '圆圆', '女', '15889658741', NULL, NULL);
