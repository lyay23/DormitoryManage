    ...
    methods: {
        async load() {
            request.get("/stu/find", {
                ...
                console.log("Response from /stu/find:", res);
                if (res.code === "0" && res.data) {
                    console.log("PageInfo object:", res.data);
        ...
        reset() {
            ...
            request.get("/stu/find", {
                ...
                console.log("Response from /stu/find (reset):", res);
                if (res.code === "0" && res.data) {
                    this.tableData = res.data.list;
                    this.total = res.data.total;
                    this.currentPage = 1;
                ...
                console.error("Error fetching student data (reset):", err);
                ElMessage({
                    message: '请求数据异常',
                    type: "error",
                });
